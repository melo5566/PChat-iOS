...
@interface DiscussionCommentTableViewCell() <UITableViewDataSource, UITableViewDelegate>
...
//    if ([UserModel isNormalUserLoggedIn]) {
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        UIImageView *loadMoreImage = [[UIImageView alloc] initWithFrame:CGRectMake((kScreenWidth - kDiscussionCardLeftAndRightPadding * 2 - 20) / 2, 5, 20, 20)];
        loadMoreImage.backgroundColor = [UIColor clearColor];
        [loadMoreImage setImage:[UIImage imageNamed:@"checkbox"]];
